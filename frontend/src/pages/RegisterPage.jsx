    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex flex-1 bg-[#0F172A] items-center justify-center p-12">
        <div className="max-w-md text-white">
          ...
          <img
            src="https://images.unsplash.com/photo-1748346918817-0b1b6b2f9bab?crop=entropy&cs=srgb&fm=jpg&ixid=M3w3NDk1Nzh8MHwxfHNlYXJjaHw0fHxkaXZlcnNlJTIwcHJvZmVzc2lvbmFscyUyMG1vZGVybiUyMG9mZmljZSUyMGNvbGxhYm9yYXRpb258ZW58MHx8fHwxNzY5MjMzMDI4fDA&ixlib=rb-4.1.0&q=85"
            alt="Modern office"
